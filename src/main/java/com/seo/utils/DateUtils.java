...
public class DateUtils {
    ...
    public static final Integer DAYS_DEFAULT = -2;
     ...
     * @return
     */
    public static String getBeforRandomDays(Integer days) {
        if (null == days) {
            days = DAYS_DEFAULT;
        }
        Date date = dateAddDays(null, days);
        return randomDate(dateFormat(date, null), dateFormat(dateAddDays(null, 1), null));
    }
    ...
    public static void main(String[] args) {
        String date =  getBeforRandomDays(null);
